...
//creacion de un elemento desde cero

function  crearElemento(){
    const nuevoElemento = document.createElement("p");
    nuevoElemento.innerHTML = `Este es un nuevo <strong class="color">parrafo</strong> `
     document.getElementById("titulo").appendChild(nuevoElemento); //insertando un nuevo elemento
}